...
// describe('Recipes', function(){
  ...
  it('should list recipes on GET', function() {
    ...
    // return chai.request(app)
      ...
      .then(function(res) {
        ...
        // res.body.should.have.length.of.at.leat(1);
  ...
  it('should add a recipe on POST', function() {
    ...
    // return chai.request(app)
      ...
      .then(function(res) {
        ...
        //res.body.ingredients.should.include.members(newRecipe.ingreidents);
      });
      //})
  });
  //})
  ...
  it('should delete recipes on DELETE', function() {
    //('should delete recipes on DELETE', function(){
    return chai.request(app)
    // return chai.request(app)
